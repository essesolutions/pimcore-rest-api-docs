...
## Input Parameters
 Parameters given in input while defining a WYSIWYG attribute of an object.The same parameters are received in output while retrieving the attribute. <br>
