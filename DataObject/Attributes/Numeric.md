...
## Input Parameters
 Parameters given in input while defining a Numeric attribute of an object.The same parameters are received in output while retrieving the attribute. <br>
...
<table style="width: 100%">
        ...
        <tr>
         ...
         <tr>
            ...
            <td>Type of the attribute (es. integer,decimal)</td>
            <td>string</td>
        </tr>
        <tr>
