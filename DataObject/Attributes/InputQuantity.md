...
InputQuantity Configuration
-----

## Input Parameters
 Parameters given in input while defining an input quantity attribute of an object.The same parameters are received in output while retrieving the attribute. <br>
...
<table style="width: 100%">
        ...
        <tr>
            ...
            <td>Name of the input quantity attribute</td>
            <td>string</td>
        </tr>
        <tr>
            <td> value <span style="color: red;">&#9733;</span></td>
            <td>Value of the input quantity attribute</td>
            <td>string</td>
        </tr>
        <tr>
            <td> Properties </td>
