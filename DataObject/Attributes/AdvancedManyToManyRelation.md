...
Advanced Many-To-Many Relation Configuration
-----

## Input Parameters
 Parameters given in input while defining an advanced many-to-many attribute of an object.
...
## Output Parameters
Parameters given in output while retrieving an advanced many-to-many attribute of an object.
