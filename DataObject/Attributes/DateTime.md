...
## Input Parameters
 Parameters given in input while defining a data time attribute of an object. <br>
...
<table style="width: 100%">
        ...
        <tr>
            <td> Properties </td>
            <td>A list of custom properties associated with the date time attribute. Each property contains metadata such as name,type and value. </td>
            <td>
...
#
## Output Parameters
Parameters received in output while retrieving a data time attribute of an object. <br>
